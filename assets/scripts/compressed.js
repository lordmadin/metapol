...
function hasScrolled() {
    ...
    if (!(Math.abs(lastScrollTop - t) <= delta)) {
        for (var s in n = lastScrollTop < t ? "down" : t < lastScrollTop ? "up" : "none", 0 === t ? n = "start" : i - e <= t && (n = "end"), throttleArr) "function" == typeof throttleArr[s] && throttleArr[s](n, t, lastScrollTop, 
...
VLTJS.window.on("load resize scroll orientationchange", function () {
    ...
    VLTJS.throttleScroll = function (t) {
    ...
    function (u) {
        ...
        VLTJS.fullpageSlider = {
            init: function () {
                ...
                void 0 !== u.fn.pagepiling && (e = u(".vlt-fullpage-slider"), n = e.find(".vlt-fullpage-slider-progress-bar"), i = e.find(".vlt-fullpage-slider-numbers"), t = !!e.data("loop-top"), s = !!e.data("loop-bottom"), a = e.data("speed") || 800, r = [], 
                
        VLTJS.body.css("overflow", "hidden"), 
                
        VLTJS.html.css("overflow", "hidden"), e.find("[data-anchor]").each(function () {
                    ...
                    afterRender: function () {
                        n.find("li:first-child").addClass("active").end().addClass("is-show"), l(), c(), 
    ...
    function (l) {
        ...
        VLTJS.document.keyup(function (t) {
                    27 === t.keyCode && c && (t.preventDefault(), 
                    
            VLTJS.menuOffcanvas.close_menu(e, o, i, n, s))
    ...
    function (d) {
        ...
        VLTJS.projectShowcase = {
            ...
            initParallax: function () {
                ...
                }), i.eq(0).trigger("mouseenter"), 
                
        VLTJS.window.on("mousemove", function (t) {
